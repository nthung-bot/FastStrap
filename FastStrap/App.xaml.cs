...
namespace FastStrap
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "FastStrap-QA";
#else
        public const string ProjectName = "FastStrap";
#endif
        public const string ProjectOwner = "FastWind";
        public const string ProjectRepository = "FastWind/FastStrap";
        public const string ProjectDownloadLink = "https://github.com/FastWind/FastStrap";
        public const string ProjectHelpLink = "https://bloxstraplabs.com/wiki/help/";
        public const string ProjectSupportLink = "https://github.com/FastWind/FastStrap/issues/new";
        ...
        public static string WebUrl
        {
            get {
                ...
                string url = ConstructFastStrapWebUrl();
        ...
        public static string ConstructFastStrapWebUrl()
        {
