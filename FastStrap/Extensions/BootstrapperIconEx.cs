...
namespace FastStrap.Extensions
{
    static class BootstrapperIconEx
    {
        public static IReadOnlyCollection<BootstrapperIcon> Selections => new BootstrapperIcon[]
        {
            ...
            BootstrapperIcon.IconFastStrapClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconFastStrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconFastStrap => Properties.Resources.IconFastStrap,
                ...
                BootstrapperIcon.IconFastStrapClassic => Properties.Resources.IconFastStrapClassic,
                _ => Properties.Resources.IconFastStrap
            };
        }
    }
}
