...
{
    public class FastStrapViewModel : NotifyPropertyChangedViewModel
    {
        ...
        private void ExportData()
        {
            ...
            { 
                FileName = $"FastStrap-export-{timestamp}.zip",
        ...
        {
            const string LOG_IDENT = "FastStrapViewModel::AddFilesToZipStream";
